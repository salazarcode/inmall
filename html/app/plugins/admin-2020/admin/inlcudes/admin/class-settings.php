						...
						<div class="uk-padding uk-container uk-container-small">
							<template v-for="option in settings">
								...
								<div v-if="option.option_name == activeTab">
									...
									<template v-if="option.option_name == 'admin2020_general'">
											<div v-if="activated"  style="margin-bottom:40px;">
												<div class="uk-alert-success" uk-alert style="background: #c1efdd;">
													<a class="uk-alert-close" uk-close></a>
													<div class="uk-grid uk-grid-small">
														<div class="uk-width-auto">
															<span class="uk-label"><?php _e('Active','admin2020') ?></span>
														</div>
														<div class="uk-width-expand">
															<div class="uk-h5">
																<?php _e('UIPress licence is active. For support please send us a message on our website.','admin2020')?>
															</div>
														</div>
													</div>
												</div>
											...
											<div v-if="!activated" style="margin-bottom:40px;">
												<div class="uk-alert-danger" uk-alert style="background: #ffced7;">
													<a class="uk-alert-close" uk-close></a>
													<div class="uk-grid uk-grid-small">
														<div class="uk-width-auto">
															<span class="uk-label " style='background:#f0506e'><?php _e('Not Active','admin2020') ?></span>
														</div>
														<div class="uk-width-expand">
															<div class="uk-h5">
																<?php _e('UIPress is not activated, please enter a valid licence key below.','admin2020')?>
															</div>
														</div>
													</div>
												</div>
