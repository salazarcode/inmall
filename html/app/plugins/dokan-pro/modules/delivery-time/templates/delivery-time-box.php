...
$delivery_date_label = isset( $info['vendor_delivery_options']['delivery_date_label'] ) ? $info['vendor_delivery_options']['delivery_date_label'] : __( 'Select delivery time', 'dokan' );
...
<div id="dokan-delivery-time-box">
    <div class="header">
        <h3><?php esc_html_e( 'Delivery time details', 'dokan' ); ?></h3>
