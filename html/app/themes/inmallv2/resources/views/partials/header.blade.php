  ...
  <div class="container">
    <div class="navbar-brand">
      <a  style="pointer-events: auto;"class="level-item has-margin-right-20 has-padding-5" href="{{home_url()}}">
        <img src="@asset('images/logo.svg')" width="200">
      </a>
      @include('components.translator')
    </div>
      ...
      <div class="navbar-end">
        <div class="navbar-item">
          <div class="buttons is-flex align-items-center">
            <a href="{{home_url('/shop')}}" style="pointer-events: auto;" class="has-margin-right-40 button is-primary is-inverted is-marginless">
              Ir al marketplace
            </a>
            <a href="{{home_url('/my-account')}}" style="pointer-events: auto;" class="has-margin-right-40 button is-outlined is-primary is-marginless">
              Inicia ahora
            </a>
