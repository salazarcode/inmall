...
<div class="has-background-white" data-aos data-scroll data-scroll-speed="10" style="height: 100vh;width:100vw;position: fixed;z-index: -1;">
  <div class="padre-voltis" style="z-index: 1;opacity: 0.3;position: fixed;top: 0;width: 250vw;height: 330vh">
    <div class="bg-hero" style="opacity: 0.5;background: url(@asset('images/2.png')) center center / cover no-repeat;"></div>
    <div class="bg-hero" style="transform: rotatez(180deg) rotatey(180deg);opacity: 0.3;background: url(@asset('images/2.png')) center center / cover no-repeat;"></div>
    <div class="bg-hero" style="opacity: 0.5;background: url(@asset('images/2.png')) center center / cover no-repeat;"></div>
  </div>
</div>
@endif
